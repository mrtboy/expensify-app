...
const exp2 = store.dispatch(addExpense({description: 'Cafe', amount: 300, createdAt: -1000}));
// store.dispatch(addExpense({description: 'Travel', amount: 500}));

// store.dispatch(removeExpense({id: exp1.expense.id}));

// store.dispatch(editExpense(exp2.expense.id, {description: 'test'}));
